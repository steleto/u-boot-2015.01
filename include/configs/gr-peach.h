/*
 * Configuation settings for the Renesas GR-PEACH board
 *
...
#ifndef __GR_PEACH_H
#define ___GR_PEACH_H

#define CONFIG_ARMV7		1	/* This is an ARM V7 CPU core */
#define CONFIG_CPU_RZA1	1
#define CONFIG_BOARD_LATE_INIT	1
#define CONFIG_MACH_TYPE MACH_TYPE_GR_PEACH
#define CONFIG_BOARD_EARLY_INIT_F
#define CONFIG_SYS_GENERIC_BOARD
#define CONFIG_MBED_BOOTLOADER	1
...
/* #define SPI_FLASH_LOADER */
 ...
 #define CONFIG_ENV_IS_NOWHERE
  ...
  #define CONFIG_SYS_TEXT_BASE		0x18004000
 #else
...
#define CONFIG_SYS_MEMTEST_END		(CONFIG_SYS_SDRAM_BASE + 2 * 1024 * 1024)
